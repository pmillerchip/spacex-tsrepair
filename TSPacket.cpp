...
{
  if ((data[3] & 0x20) == 0) return((unsigned char*)0);
...
TSPacket::hasPCR() const
{
  ...
  if (af == (const unsigned char*)0) return(false);  // PCR is in AF, and AF is not present
...
TSPacket::removePCR()
{
  ...
  if (af == (unsigned char*)0) return;  // PCR is in AF, and AF is not present
...
{
  const unsigned char* af = adaptationField();
  if (af == (const unsigned char*)0) return(false);  // OPCR is in AF, and AF is not present
...
TSPacket::getPCR() const
{
  ...
  unsigned long long int rv =
    (((unsigned long long int)af[2]) << 40)
  | (((unsigned long long int)af[3]) << 32)
  | (((unsigned long long int)af[4]) << 24)
  | (((unsigned long long int)af[5]) << 16)
  | (((unsigned long long int)af[6]) << 8)
  | (((unsigned long long int)af[7]));
  return(rv);
}
...
{
  unsigned char* af = adaptationField();
  if (af == (unsigned char*)0) return(0);
...
TSPacket::hasPTS() const
{
  ...
  if (pay == (const unsigned char*)0) return(false);
...
{
  const unsigned char* pay = payload();
  if (pay == (const unsigned char*)0) return(0);
  ...
  return(((unsigned long long int)(pay[9]  & 0x0e) << 29)
       | ((unsigned long long int)(pay[10] & 0xff) << 22)
       | ((unsigned long long int)(pay[11] & 0xfe) << 14)
       | ((unsigned long long int)(pay[12] & 0xff) << 7)
       | ((unsigned long long int)(pay[13] & 0xfe) >> 1));
}
